...
public class TutoShooterBehaviour : MonoBehaviour
{
    ...
    public float rad;
    public TutoBallMovement control;
    ...
    void FixedUpdate()
    {
        Tuto = Manejar.control;
        balls = GameObject.FindGameObjectsWithTag("Player");
        foreach (GameObject ball in balls)
        {
            control = ball.GetComponent<TutoBallMovement>();
        }
